...
MODEL_NAME="o4-mini"
TASK_TYPE="multi_choice_qa"
DATASET_PATH="/Users/minjiyoo/Documents/GitHub/llm-trust-issue/articles_subset4_1.csv"
USE_COT=false # use cot or not
TEMPERATURE=0.7
TOP_K=3
...
# RESULT_FILE="final_output/top_k_self_random_5/o4-mini/ReutersNews/ReutersNews_o4-mini_07-11-23-40.json"
USE_COT_FLAG=""
